	...
	<el-row class="container">
		<el-col :span="24" class="header">
			<el-col :span="10" class="logo" :class="collapsed?'logo-collapse-width':'logo-width'">
				<!--{{collapsed?'':sysName}}-->
				<img  src="/walmart/static/img/logo_eda.png" style="width:105px" class="img_logo"/> <!-- /walmart-->
			</el-col>
			<el-col :span="10">
				<div class="tools" @click.prevent="collapse">
					<i class="fa fa-align-justify" style="margin-left: -72px;"></i>
				</div>
			</el-col>
	...
	export default {
		...
		methods: {
			...
			collapse:function(){
				...
				//$(".img_logo").addStyle("display:none");
			},
			showMenu(i,status){
