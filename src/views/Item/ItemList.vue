<template>
    <section>
        ...
        <el-table :data="items" highlight-current-row v-loading="listLoading"
            ...
            <el-table-column prop="productType" label="Product Type" width="140" sortable>
            </el-table-column>
            <el-table-column prop="price_currency" label="Price Amount" width="130" >    <!--price_amount-->
            </el-table-column>
            <!--<el-table-column prop="currency" label="currency" min-width="110" sortable>
            </el-table-column>-->
            ...
            <el-table-column prop="fulfillmentLagTime" label="Fulfillment Lag Time" min-width="170" >
            </el-table-column>
        ...
        <el-dialog title="Edit" v-model="editFormVisible" :close-on-click-modal="false">
            <el-form :model="editForm" label-width="120px" :rules="editFormRules" ref="editForm">
                <el-form-item label="price" prop="price_amount">
                    <el-input v-model.number="editForm.price_amount" auto-complete="off" type="number"></el-input>
                </el-form-item>
        ...
        <el-dialog title="Edit" v-model="editInventoryFormVisible" :close-on-click-modal="false">
            <el-form :model="editForm" label-width="120px" :rules="editFormRules" ref="editForm">
                <el-form-item label="inv_amount" prop="inv_amount">
                    <el-input v-model.number="editForm.inv_amount" auto-complete="off"></el-input>
                </el-form-item>
                ...
                <el-form-item label="fulfillmentLagTime" prop="fulfillmentLagTime">
                    <el-input v-model.number="editForm.fulfillmentLagTime" auto-complete="off"></el-input>
                </el-form-item>

            </el-form>
            <div slot="footer" class="dialog-footer">
                <el-button @click.native="editInventoryFormVisible = false">Cancel</el-button>
                <el-button type="primary" @click.native="editInventorySubmit" :loading="editInventoryLoading">Submit</el-button>
            </div>
        </el-dialog>
        ...
        <el-dialog title="AddPromotion" v-model="addPromotionFormVisible" :close-on-click-modal="false">
            <el-form :model="addPromotionForm" label-width="120px" :rules="addPromotionFormRules"
                ...
                <el-form-item label="sku" prop="sku">
                    <el-input v-model="addPromotionForm.sku" auto-complete="off" readonly="readonly"></el-input>
                </el-form-item>
                <el-form-item label="currentPrice" prop="currentPrice">
                    <el-input v-model="addPromotionForm.currentPrice" auto-complete="off"></el-input>
                </el-form-item>
                <el-form-item label="comparisonPrice" prop="comparisonPrice">
                    <el-input v-model="addPromotionForm.comparisonPrice" auto-complete="off"></el-input>
                </el-form-item>
                <el-form-item label="priceType" prop="priceType">
                    <select v-model="addPromotionForm.priceType">
                        <option>BASE</option>
        ...
        <!--查看促销界面-->
        <el-dialog title="Info" v-model="getFormVisible" :close-on-click-modal="false">
            <el-form :model="addForm" label-width="120px" ref="addForm">
                <el-form-item label="sku" prop="sku">
                    <el-input v-model="addForm.sku" auto-complete="off" readonly="readonly"></el-input>
                </el-form-item>
                <el-form-item label="price" prop="price_amount">
                    <el-input v-model="addForm.currentPrice" auto-complete="off" readonly="readonly"></el-input>
                </el-form-item>
                <el-form-item label="comparisonPrice" prop="comparisonPrice">
                    <el-input v-model="addForm.comparisonPrice" auto-complete="off" readonly="readonly"></el-input>
                </el-form-item>
                <el-form-item label="priceType" prop="priceType" readonly="readonly">
                    <select v-model="addForm.priceType">
                        <option>BASE</option>
                        <option>REDUCED</option>
                        <option>CLEARANCE</option>
                    </select>
                ...
                <el-form-item label="effectiveDate" readonly="readonly">
                    <el-date-picker type="datetime" v-model="addForm.effectiveDate"></el-date-picker>
                </el-form-item>
                <el-form-item label="expirationDate" readonly="readonly">
                    <el-date-picker type="datetime" v-model="addForm.expirationDate"></el-date-picker>
                </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
                <el-button @click.native="getFormVisible = false">Cancel</el-button>
            </div>
        </el-dialog>
    </section>
</template>
        ...
        data() {
            return {
                ...
                addPromotionFormRules: {
                    ...
                    expirationDate: [
                        {required: true, message: 'Please choose the right expirationDate !', trigger: 'change'}
                    ]
                },
                //新增界面数据
                addPromotionForm: {
